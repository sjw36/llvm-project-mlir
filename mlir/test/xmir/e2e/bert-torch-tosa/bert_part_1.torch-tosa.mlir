...
// CHECK: [1 1 1]
module {
  func.func @bert_part_1(%arg0: tensor<1x12x384xf32> {func.read_access}, %arg1: tensor<384x384xf32> {func.read_access}, %arg2: tensor<1x1x384xf32> {func.read_access}) -> (tensor<12x32x12xf32> {func.write_access}) {
