...
// CHECK: [1 1 1]
module {
  func.func @bert_part_0(%arg0: tensor<1x12x384xf32> {func.read_access}, %arg1: tensor<384x384xf32> {func.read_access}, %arg2: tensor<1x1x384xf32> {func.read_access}) -> (tensor<12x12x32xf32> {func.write_access}) {
      ...
      %6 = "tosa.reshape"(%5) {new_shape = [12, 12, 32]} : (tensor<1x12x12x32xf32>) -> tensor<12x12x32xf32>
      return %6 : tensor<12x12x32xf32>
    }
}
