...
// CHECK: [1 1 1]
module {
  func.func @bert_part_14(%arg0: tensor<1x12x384xf32> {func.read_access}, %arg1: tensor<384x1536xf32> {func.read_access}, %arg2: tensor<1x1x1536xf32> {func.read_access}) -> (tensor<1x12x1536xf32> {func.write_access}, tensor<1x12x1536xf32> {func.write_access}) {
