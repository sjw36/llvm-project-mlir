...
func.func @forward__part_0(%arg0: memref<1x128x64xf32> {func.read_access}, %arg1: memref<1x64x256xf32> {func.read_access}, %arg2: memref<1x128x1xf32> {func.write_access}) {
  %cst = arith.constant 0.0 : f32
  linalg.fill ins(%cst : f32) outs(%arg2 : memref<1x128x1xf32>)
  return
}

func.func @forward(%arg0: memref<1x128x64xf32>, %arg1: memref<1x64x256xf32>, %arg2: memref<1x128x1xf32>) {
  %token_0 = mhal.launch @forward__part_0 (%arg0, %arg1, %arg2) : (memref<1x128x64xf32>, memref<1x64x256xf32>, memref<1x128x1xf32>)
  mhal.await %token_0 : !mhal.token
  return
}

module @__gfx90a_kernels attributes {mhal.arch = "amdgcn-amd-amdhsa:gfx1030", mhal.module} {
  func.func @forward__part_0(%arg0: memref<1x128x64xf32>, %arg1: memref<1x64x256xf32>, %arg2: memref<1x128x1xf32>) attributes {kernel, original_func = @forward__part_0} {
    %cst = arith.constant 0.0 : f32
    linalg.fill ins(%cst : f32) outs(%arg2 : memref<1x128x1xf32>)
    rock.global_sync
