...
struct AmdArchInfo {
  ...
  constexpr AmdArchInfo(GemmFeatures defaultFeatures, int64_t waveSize,
                        ...
                        int64_t totalVGPRPerEU, int64_t maxThreadsPerCU,
			int64_t sharedMemPerCU, int64_t sharedMemPerWG,
      ...
      : defaultFeatures(defaultFeatures), waveSize(waveSize),
        ...
        totalVGPRPerEU(totalVGPRPerEU), maxThreadsPerCU(maxThreadsPerCU),
	totalSharedMemPerCU(sharedMemPerCU), maxSharedMemPerWG(sharedMemPerWG),
