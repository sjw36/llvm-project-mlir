...
//
//===----------------------------------------------------------------------===//
#ifndef MLIR_CONVERSION_AIRRTTOLLVM_AIRRTTOLLVMPASS_H_
#define MLIR_CONVERSION_AIRRTTOLLVM_AIRRTTOLLVMPASS_H_
...
createAIRRtToLLVMConversionPass(bool kernelBarePtrCallConv = false);

/// Collect a set of patterns to convert from the GPU dialect to LLVM and
/// populate converter for gpu types.
void populateAIRRtToLLVMConversionPatterns(LLVMTypeConverter &converter,
